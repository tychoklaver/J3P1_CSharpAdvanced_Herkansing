...
public class LoseScene : SceneBase
{
    public LoseScene(Game1 pGame) : base(pGame)
    {
    }
    ...
    public override void Draw(SpriteBatch pSpriteBatch)
    {
        ...
        Vector2 textSize = font.MeasureString("You lose!");
        Vector2 positon = new((Game1.ScreenWidth / 2) - (textSize.X / 2), (Game1.ScreenHeight / 2) - (textSize.Y / 2));

        pSpriteBatch.DrawString(font, "You lose!", positon, Color.White);
    }
}
